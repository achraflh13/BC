...
@endphp
    ...
    <div class="p-1">
      <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
        <div class="me-3">
          <img class="wd-30 ht-30 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('img/admin_images/'.$profileData->photo) : url('img/no_image.jpg') }}" alt="userr">
        </div>
        ...
        <div class="flex-grow-1 me-2">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="wd-30 ht-30 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('img/admin_images/'.$profileData->photo) : url('img/no_image.jpg') }}" alt="profile">
                </a>
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            <img class="wd-80 ht-80 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('img/admin_images/'.$profileData->photo) : url('img/no_image.jpg') }}" alt="">
                        </div>
    ...
    <ul class="list-unstyled p-1">
      ...
      <li class="dropdown-item py-2">
        <a href="{{route('agent.profile.password')}}" class="text-body ms-0">
